	...
	(function(){
		...
		var classRooms=[{
			...
			classRoomController.$inject=['$scope']; // uglificationa and minification will not change the name of dependecy like scope
			angular.module("cApp").controller("classRoomController",classRoomController);
